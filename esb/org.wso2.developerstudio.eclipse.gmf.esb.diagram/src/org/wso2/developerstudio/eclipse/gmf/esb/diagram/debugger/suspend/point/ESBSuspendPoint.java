package org.wso2.developerstudio.eclipse.gmf.esb.diagram.debugger.suspend.point;
...
public class ESBSuspendPoint extends Breakpoint {
	...
	public ESBSuspendPoint(final IResource resource, final int lineNumber,
			final ESBDebugPoint suspendPoint) throws DebugException {
		this(resource, lineNumber, suspendPoint, null);
	}

	public ESBSuspendPoint(final IResource resource, final int lineNumber,
			final ESBDebugPoint suspendPoint, final String toolTipMessage)
