...
public class URLRewriteMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new URLRewriteMediatorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new FeedbackIndicateDragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new URLRewriteMediatorCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof URLRewriteMediatorInputConnectorEditPart) {
			...
			IFigure borderItemFigure = ((URLRewriteMediatorInputConnectorEditPart) childEditPart).getFigure();
			...
			IFigure borderItemFigure = ((URLRewriteMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
