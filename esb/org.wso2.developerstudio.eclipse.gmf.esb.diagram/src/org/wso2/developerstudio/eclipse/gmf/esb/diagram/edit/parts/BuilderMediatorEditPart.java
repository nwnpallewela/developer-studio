...
public class BuilderMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new BuilderMediatorItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BuilderMediatorInputConnectorEditPart) {
			IFigure borderItemFigure = ((BuilderMediatorInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof BuilderMediatorOutputConectorEditPart) {
			IFigure borderItemFigure = ((BuilderMediatorOutputConectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
