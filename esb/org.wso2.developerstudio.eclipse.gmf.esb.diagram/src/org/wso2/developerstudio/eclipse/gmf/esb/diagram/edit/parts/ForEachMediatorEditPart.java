...
public class ForEachMediatorEditPart extends SingleCompartmentComplexFiguredAbstractMediator {
	...
	protected void createDefaultEditPolicies() {
		...
		// XXX need an SCR in runtime to have another abstract superclass that would let children add reasonable editpolicies
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ForEachMediatorDescriptionEditPart) {
			((ForEachMediatorDescriptionEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureForEachMediatorPropertyValue());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ForEachMediatorInputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((ForEachMediatorInputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ForEachMediatorOutputConnectorEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((ForEachMediatorOutputConnectorEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
