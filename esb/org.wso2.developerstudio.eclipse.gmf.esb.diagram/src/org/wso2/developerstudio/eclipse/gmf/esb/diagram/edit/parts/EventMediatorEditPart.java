...
public class EventMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EventMediatorInputConnectorEditPart) {
			IFigure borderItemFigure = ((EventMediatorInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof EventMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure = ((EventMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
