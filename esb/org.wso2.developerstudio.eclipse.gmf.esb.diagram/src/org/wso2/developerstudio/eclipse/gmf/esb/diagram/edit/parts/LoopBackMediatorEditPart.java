...
public class LoopBackMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LoopBackMediatorItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LoopBackMediatorDescriptionEditPart) {
			((LoopBackMediatorDescriptionEditPart) childEditPart).setLabel(getPrimaryShape().getLogDescriptionLabel());
			return true;
		}
		if (childEditPart instanceof LoopBackMediatorInputConnectorEditPart) {
			IFigure borderItemFigure = ((LoopBackMediatorInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof LoopBackMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure = ((LoopBackMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
