...
public class CalloutMediatorEditPart extends FixedSizedAbstractMediator {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CalloutMediatorItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CalloutMediatorInputConnectorEditPart) {
			IFigure borderItemFigure = ((CalloutMediatorInputConnectorEditPart) childEditPart).getFigure();
		...
		if (childEditPart instanceof CalloutMediatorOutputConnectorEditPart) {
			IFigure borderItemFigure = ((CalloutMediatorOutputConnectorEditPart) childEditPart).getFigure();
			BorderItemLocator locator = new FixedBorderItemLocator(getMainFigure(), borderItemFigure,
